...
check('Tour band table reports the ruled figures',
  JSON.stringify(tour)===JSON.stringify(['All\n1.44\n41,667\n-2.14%','All\n3.00\n41,667\n-5.44%']), JSON.stringify(tour));
...
check('Season caption keeps 0.14em (1.4px)', season && season.ls==='1.4px' && season.t==='Season', JSON.stringify(season));
