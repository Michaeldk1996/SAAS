...
for (const f of files) {
  ...
  for (let li = 1; li < lines.length; li++) {
    ...
    // (2009 already carries no Pinnacle pair -> falls out via noPrice, not here.)
...
const recon = bucket.used + bucket.walkover + bucket.edge + bucket.noPrice + bucket.tie + bucket.overround + bucket.preWindow;
