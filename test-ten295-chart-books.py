...
check(rc == 0 and calls == ['chart_book_series', 'price_history'], f'main(): one series call + one price_history per Bet105 card {calls}')
...
check(not got[1].get('oddsMovement'), 'a 404 writes nothing — no invented line, no meta')
